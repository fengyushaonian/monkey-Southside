...
//                }
//                if (clicked != null) {
//                    mc.getConnection().sendPacket(new CPacketCustomPayload("germmod-netease", new PacketBuffer(new PacketBuffer(Unpooled.buffer().writeInt(13))
//                            .writeString(clicked.getParentUuid())
//                            .writeString(clicked.getPath())
//                            .writeInt(0))
//                    ));
//                    mc.getConnection().sendPacket(new CPacketCustomPayload("germmod-netease", new PacketBuffer(Unpooled.buffer().writeInt(11))
//                            .writeString(clicked.getParentUuid())
//                    ));
