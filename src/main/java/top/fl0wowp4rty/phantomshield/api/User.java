...
public class User {
    ...
    public String getHwid() {
        ...
        try {
            ...
            return cachedHwid = (String)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, -880546435, null);
    ...
    public short[] getExpiredDate() {
        ...
        try {
            Class<?> clz = Class.forName("xyz.blackfaithfully.License");
            short year = (short)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, -981416308, null);
            if (year == 0)
                return null;
            short month = (short)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, -1339053248, null);
            short day = (short)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, 1738243113, null);
    ...
    public String getUsername(String defaultName) {
        try {
            ...
            return cachedUsername = (String)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, 915131260, null);
        } catch (Throwable ignored) {
        }
    ...
    public int authenticate(String code) {
        try {
            Class<?> clz = Class.forName("xyz.blackfaithfully.License");
            return (int)
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, 370149742, code);
        } catch (Throwable ignored) {
        }
    ...
    public byte[] getUserData() {
        try {
            Class<?> clz = Class.forName("xyz.blackfaithfully.License");
            cachedData = (byte[])
                    clz.getDeclaredMethod("invoke", int.class, Object.class).invoke(null, 1523499410, null);
            return cachedData;
        } catch (Throwable ignored) {
        }
